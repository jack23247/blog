...
<!-- Back in June I got a truckload of IBM stuff from a fellow collector who lives at a ~3hr drive from me. In that occasion, I recovered: - a 9401-150 without any DASD, which is our protagonist, - a complete and nice looking 9401 Advanced Entry, - a very beaten up, dirty and sad-looking 9406-170, - a 9401-150 chassis with some boards, - a 3477-6 color terminal with the fancy stand and, - a freebie IBM VGA monitor for a PS/2. He had many other items like an older terminal and a ton of twinax cables and goodies, but I've decided to leave him most of the stuff so he could still operate his /36 and CISC /400 gear (he has quite a collection) in case he wanted to. Since the 9401 AE and 9406-170 were complete, I tried to IPL them: unsurprisingly, the AE works flawlessly (even if it's pretty limited), and to my complete disbelief the 170 is perfectly fine too. The 150s, however, were a different story: the working one had a missing front plastic bezel, while the other one was missing most of its internals: point is, neither had their DASD installed when I got them. I unceremoniously decided to strip the crippled one of its front bezel, and to use the resulting machine as an housing for the core I recovered from the other poor fella (yeah there were four 150s in the same room at this point) I got from a friend's lawn, which was featured in "Core Transfer". Due to the magic properties of the Model 150, the system IPLd perfectly fine with the new core and I was able to learn that the lawn guy had been keeping payrolls for a livestock company till 2013 at the very least: at this point, I was pretty satisfied with the results and I moved the donor units to storage, and decided I that re-installing the OS could wait. Fast forward to the last weekend: since my COVID shot gave me a sore arm and some lightheadedness, I've decided to stay put and waste a couple hours doing funny computer stuff. I wasn't in the mood to tinker with the hardware so I looked at my desk and realized that I still had to give the old boy a coat of fresh V4R4 paint. -->

Back in June I got a pallet of AS/400 stuff from a fellow collector who lives at a ~3hr drive from me, and is downsizing his impressive collection. The haul included a pair of model 150s that were either missing this or that thing, and most importantly didn't have any DASD: since I was able to combine the two machines into a working and good-looking system, I figured that the core that came with `44-L5517` (which was featured in "Core Transfer")  could be rehoused. While the system IPLed fine with the new core, the ASP was full of payroll crud from a livestock company which had been running it until (at least) 2013, so I decided to start anew with a fresh V4R4 installation.
